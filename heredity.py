...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        # Set the number of copies of the gene
        # the person has
        gene_num = 0
        ...
        # Set whether the person has the trait or not
        has_trait = False
        if person in have_trait:
            has_trait = True
        
        # Record the probability that person has
        # gene_num copies of gene and has_trait
...
def normalize(probabilities):
    ...
    for person in normalized:
        gene_sum = sum(normalized[person]["gene"].values())
        trait_sum = sum(normalized[person]["trait"].values())

        normalized[person]["trait"][True] /= trait_sum
        normalized[person]["trait"][False] /= trait_sum
        
        for i in range(3):
            normalized[person]["gene"][i] /= gene_sum
